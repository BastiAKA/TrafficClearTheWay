namespace ClearTheWay
{
    ...
    internal static class Tuning
    {
        ...
        internal const float kTowReturnSearchRadius = 120f; // how far to look for a road to put a wedged truck back on. Generous, because a vehicle that drove blind can be well inside a block; if nothing is found in this radius, it is beyond saving and gets deleted.
